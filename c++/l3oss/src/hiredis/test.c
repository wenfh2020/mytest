...
static void test_blocking_connection(struct config config) {
    ...
    freeReplyObject((redisReply*)redisCommand(c,"LPUSH mylist foo"));
    freeReplyObject((redisReply*)redisCommand(c,"LPUSH mylist bar"));
    ...
    freeReplyObject((redisReply*)redisCommand(c,"MULTI"));
    freeReplyObject((redisReply*)redisCommand(c,"LRANGE mylist 0 -1"));
    freeReplyObject((redisReply*)redisCommand(c,"PING"));
...
static void test_throughput(struct config config) {
    ...
    t1 = usec();
    for (i = 0; i < num; i++) {
        replies[i] = (redisReply*)redisCommand(c, "INCRBY incrkey %d", 1000000);
...
//     (redisReply*)redisCommand(c,"PING");
...
//     c = __connect_nonblock();
//     (redisReply*)redisCommandWithCallback(c,__test_reply_callback,(void*)1,"PING");
//     (redisReply*)redisCommandWithCallback(c,__test_reply_callback,(void*)2,"PING");
//     (redisReply*)redisCommandWithCallback(c,__test_reply_callback,(void*)3,"PING");
//
//     /* Write output buffer */
//     wdone = 0;
//     while(!wdone) {
